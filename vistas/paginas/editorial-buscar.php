...
<div class="container">
    ...
    <li>
      <a href="<?php echo urlServidor; ?>editorial-listar/"><i class="fa-solid fa-clipboard-list fa-fw"></i> &nbsp; Lista de editorial</a>
        ...
        <li>
            <a href="<?php echo urlServidor; ?>editorial-nuevo/"><i class="fa-solid fa-plus fa-fw"></i> &nbsp; Registrar editorial</a>
        </li>
        <li>
            <a href="<?php echo urlServidor; ?>editorial-buscar/"><i class="fa-solid fa-magnifying-glas fa-fw"></i> &nbsp; buscar editorial</a>
        </li>
    </ul>
</div>
<div class="container">
    <div class="px-3">
        <div class="card">
            <div class="card-body">
                <?php if(!isset($_SESSION['busqueda_editorial']) && empty($_SESSION['busqueda_editorial'])) { ?>
                    <form action="<?php echo urlServidor; ?>rutas/buscadorRuta.php" method="post" class="Formulario" data-form="default" autovomplete="off">
                        <input type="hidden" name="modulo" value="editorial">
                            <div class=contairner">
                                <div class="row justify-content-center"> 
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <input type="text" name="buscar_palabra" class="form-control form-control-sm" placeholder="¿que editorial estas buscando?">
                                        </div>
                                    </div>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="contairner text-center">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="m-0">
                                            <p>Resultados de la busqueda <strong><?php echo $_SESSION['busqueda_editorial']; ?>
                                        </strong></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
            ...
            <?php
                ...
                echo $controlador_editorial->listar_editorial_controlador($pagina [1], 10, $_SESSION['privilegio_b'],
                $_SESSION['id_b'], $pagina[0], $_SESSION['busqueda_editorial']);
            }
            ?>
            </div>
        </div>
