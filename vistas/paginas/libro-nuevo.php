<div class="container">
    <h3 class="text-uppercase px-3 py-4"><i class="fa-solid fa-user-tie fa-fw"></i> Modulo de listar un libro</h3>
</div>
<div class="container">
    <ul class="full-box list-unstyled page-tabs">
        <li>
            <a href="<?php echo urlServidor; ?>libro-listar/"><i class="text-info fa-solid fa-clipboard-list fa-fw"></i>&nbsp; Lista de libro</a>
        </li>
        <li>
            <a href="<?php echo urlServidor; ?>libro-nuevo/"><i class="text-success fa-solid fa-plus fa-fw"></i>&nbsp; Agregar libro</a>
        </li>
        <li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="mb-4">
                                    <select name="libro_autor_guardar" class="form-select form-select-sm text-center" arial-label="Default select example">
                                        <?php
