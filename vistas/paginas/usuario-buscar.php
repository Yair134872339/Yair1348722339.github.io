<div class="container">
    <h3 class="text-uppercase px-3 py-4"><i class="fa-solid fa-user-tie fa-fw"></i>modulo de usuario</h3>
</div>
<div class="container">
    <ul class="full-box list-unstyled page-tabs">
    <li>
      <a href="<?php echo urlServidor; ?>usuario-listar/"><i class="fa-solid fa-clipboard-list fa-fw"></i> &nbsp; Lista de usuarios</a>
        </li>
        <li>
            <a href="<?php echo urlServidor; ?>usuario-nuevo/"><i class="fa-solid fa-plus fa-fw"></i> &nbsp; Registrar usuario</a>
        </li>
        <li>
            <a href="<?php echo urlServidor; ?>usuario-buscar/"><i class="fa-solid fa-magnifying-glas fa-fw"></i> &nbsp; buscar usuario </a>
        </li>
    </ul>
</div>
<div class="container">
    <div class="px-3">
        <div class="card">
                        ...
                        <input type="hidden" name="modulo" value="usuario">
                            <div class=contairner">
                                <div class="row justify-content-center"> 
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <input type="text" name="buscar_palabra" class="form-control form-control-sm" placeholder="¿que usuario estas buscando?">
                                        </div>
                                    </div>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="contairner text-center">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="m-0">
                                            <p>Resultados de la busqueda <strong><?php echo $_SESSION['busqueda_usuario']; ?>
                                        </strong></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
            ...
            <?php
                ...
                echo $controlador_usuario->listar_usuario_controlador($pagina [1], 10, $_SESSION['privilegio_b'],
                $_SESSION['id_b'], $pagina[0], $_SESSION['busqueda_usuario']);
            }
            ?>
            </div>
        </div>
